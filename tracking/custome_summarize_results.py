...
if __name__ == "__main__":
    ...
    result_dir_generator = lambda sim_id: os.path.join(
        ".", f"batch_4_sim_{sim_id}_results"
    )
    sim_id_list = [1008,1369]
    ...
    # write to csv
    option_summary_df.to_csv("batch_4_sim_option_summary.csv")
    result_summary_df.to_csv("batch_4_sim_result_summary.csv")
